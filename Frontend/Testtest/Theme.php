...
namespace Shopware\Themes\Testtest;
...
SHOPWARE_EOD;
     ...
     */
    public function createConfigSets1(ArrayCollection $collection)
    {
        $set = new ConfigSet();
